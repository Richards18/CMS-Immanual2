...
import { XMAS_SERVICE_2018 } from '../../../../../Constants/Constant';
...
const XmasService2018: FC = () => {
  ...
  const imageSources = Object.values(XMAS_SERVICE_2018).map(uri => ({ uri }));
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.White }}>
      <Header title="கிறிஸ்துமஸ் சிறப்பு ஆராதனை 2018" />
...
export default XmasService2018;
