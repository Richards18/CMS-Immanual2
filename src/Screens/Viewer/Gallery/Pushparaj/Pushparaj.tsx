...
import { GOLDEN_JUBILEE, PUSHPARAJ_FN, TEMPLE_TOWER_CEREMONY, WOMENS_FESTIVAL } from '../../../../Constants/Constant';
...
const Pushparaj: FC = () => {
  ...
  const imageSources: { uri: string }[] = Object.values(PUSHPARAJ_FN).map(uri => ({ uri }));
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.White }}>
      ...
      <Header title="டாக்டர் புஷ்பராஜ் கூட்டம்" screen='PUSHPARAJ' />
