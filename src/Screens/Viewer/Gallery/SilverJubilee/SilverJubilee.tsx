...
import { GOLDEN_JUBILEE, SILVER_JUBILEE, TEMPLE_TOWER_CEREMONY, WOMENS_FESTIVAL } from '../../../../Constants/Constant';
...
const SilverJubilee: FC = () => {
  ...
  const imageSources: { uri: string }[] = Object.values(SILVER_JUBILEE).map(uri => ({ uri }));
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.White }}>
      ...
      <Header title="25 ஆண்டு வெள்ளி விழா கொண்டாட்டம்" screen='SILVER_JUBILEE' />
