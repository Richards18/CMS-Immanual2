...
import { TEMPLE_TOWER_CEREMONY, WOMENS_FESTIVAL } from '../../../../Constants/Constant';
...
const TempleTowerCeremony: FC = () => {
  ...
  const imageSources: { uri: string }[] = Object.values(TEMPLE_TOWER_CEREMONY).map(uri => ({ uri }));
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.White }}>
      ...
      <Header title="கோவில் கோபுர அடிக்கல் நடு விழா" />
