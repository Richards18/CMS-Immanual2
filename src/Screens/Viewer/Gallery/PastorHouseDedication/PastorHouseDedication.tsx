...
import { PASTOR_HOUSE_DEDICATION } from '../../../../Constants/Constant';
...
const PastorHouseDedication: FC = () => {
  ...
  const imageSources = Object.values(PASTOR_HOUSE_DEDICATION).map(uri => ({ uri }));
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.White }}>
      <Header title="ஊழியர் இல்ல பிரதிஷ்டை விழா" />
...
export default PastorHouseDedication;
